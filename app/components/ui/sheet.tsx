...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side }), className,"bg-[#141920] border-0 rounded-e-3xl text-white")}
      {...props}
      style={{zIndex:2000}}
    >
      {children}
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-foreground text-white", className)}
    {...props}
  />
))

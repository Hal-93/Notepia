...
export default function Compass({ map }: CompassProps) {
  ...
  return (
    <div
      className={`fixed mt-[132px] md:mt-[76px] right-4 z-[30] w-[48px] h-[48px] rounded-[16px] bg-black flex items-center justify-center cursor-pointer transition-opacity duration-500 ${
